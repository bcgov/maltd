...
public class SharePointResourceUserManagementService : ResourceUserManagementService
{
    ...
    public override async Task<Result<string>> AddUserAsync(Shared.User user, CancellationToken cancellationToken)
    {
    ...
    public override async Task<Result<string>> RemoveUserAsync(Shared.User user, CancellationToken cancellationToken)
    {
