...
public interface IUserManagementService
{
    ...
    Task<Result<List<ProjectResourceStatus>>> AddUserToProjectAsync(User user, ProjectConfiguration project, CancellationToken cancellationToken);
    ...
    Task<Result<List<ProjectResourceStatus>>> RemoveUserFromProjectAsync(User user, ProjectConfiguration project, CancellationToken cancellationToken);
    ...
    Task<Result<List<Project>>> GetProjectsForUserAsync(User user, CancellationToken cancellationToken);
    ...
    Task<Result<IList<UserStatus>>> GetUsersAsync(ProjectConfiguration project, ProjectResource resource, CancellationToken cancellationToken);
}
